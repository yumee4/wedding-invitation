      ...
      submitHandler: function (form) {
        ...
        $.ajax({
          ...
          success: function (hasil) {
            ...
            if (status == "sukses") {
              $(".layout-komen2").append(
                "<div class='komen2' style='display:block'><div class='col-12 komen-nama'>" +
                  nama +
                  "<i class='" +
                  kehadiran +
                  "' style='margin-left:3px;border-radius:2px;font-size:10px;padding:2px;padding-left:5px;padding-right:5px;'>" +
                  kehadiran +
                  "</i></div><div class='col-12 komen-isi'>" +
                  komentar +
                  "</div></div>"
              );
              $("html, body").animate(
